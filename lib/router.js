...
Router.configure({
  ...
  waitOn: function() {
    ...
    if (user && user.profile && user.profile.verified) {
      return [
...
Router.map(function() {
  ...
  this.route('performance5', {
    ...
    data: function() { return {"data":{"name":"kgco2move","label":"Kg Co2_eq per move","unit":"Kg Co2_eq","graphs":[{"label":"Factor","type":"spline","locationbound":false,"count":[{"form":4,"names":["fuelbarge","fuelrail"],"pre":2.7},{"form":5,"names":["fueltruck"],"pre":2.7},{"form":6,"names":["cranediesel","terminaldiesel"],"pre":2.7},{"form":1,"names":["officekwh"],"pre":0.4228},{"form":4,"names":["kwhrail"],"pre":0.4228},{"form":6,"names":["cranekwh","terminalkwh"],"pre":0.4228}],"split":[{"form":6,"names":["bargemovesin","bargemovesout","truckmovesin","truckmovesout","trainmovesin","trainmovesout"]}]}]}}},
    template: 'performance',
    before: authenticate
  });
  this.route('performance6', {
    path: '/performance/kgco2terminal',
    data: function() { return {"data":{"name":"kgco2terminal","label":"Kg Co2_eq Terminal operation","unit":"Kg Co2_eq","graphs":[{"label":"Factor","type":"spline","locationbound":true,"count":[{"form":6,"names":["cranediesel","terminaldiesel"],"pre":2.7},{"form":6,"names":["cranekwh","terminalkwh"],"pre":0.4228}],"split":[{"form":6,"names":["bargemovesin","bargemovesout","truckmovesin","truckmovesout","trainmovesin","trainmovesout"]}]}]}}},
    template: 'performance',
    before: authenticate
  });
