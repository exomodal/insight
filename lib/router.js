...
Router.map(function() {
  ...
  this.route('performance8', {
    ...
    data: function() { return {"data":{"name":"terminalliters","label":"Terminal Liters per Truckmove","unit":"L/Move","graphs":[
      {"label":"Factor",
      "type":"spline",
      "locationbound":true,
      "count":[{"form":6,"names":["cranediesel","terminaldiesel"]}],"split":[{"form":6,"names":["truckmovesin","truckmovesout"]}]},
      {"label":"Total Factor",
      "type":"spline",
      "locationbound":false,
      "count":[{"form":6,"names":["cranediesel","terminaldiesel"]}],"split":[{"form":6,"names":["truckmovesin","truckmovesout"]}]}
